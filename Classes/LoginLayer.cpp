...
bool LoginLayer::init()
{
	...
	button->setClickedHandler(CC_CALLBACK_2(LoginLayer::onButtonClick,this));
...
void LoginLayer::menuCloseCallback(Object* pSender)
{
	...
	auto callback = std::bind(&LoginLayer::onLoginResponse,this,std::placeholders::_1);
